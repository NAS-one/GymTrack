    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-950 via-black to-zinc-900 text-white font-sans selection:bg-orange-500 selection:text-white p-4">
      ...
      <div className="w-full max-w-[420px] bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl shadow-black/50 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white mb-2">Bienvenido de nuevo</h1>
        ...
        <div className="relative flex py-2 items-center mb-6">
            ...
            <span className="flex-shrink-0 mx-4 text-xs font-medium text-zinc-500 uppercase tracking-widest">o con email</span>
            <div className="flex-grow border-t border-zinc-800"></div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-zinc-400 ml-1 uppercase tracking-wide">Usuario</label>
            <input 
              type="text" 
              value={username}
        ...
        <p className="text-center text-xs text-zinc-500 mt-8">
            ¿No tienes cuenta? <span className="text-zinc-300 font-medium">Contacta al administrador</span>
        </p>
